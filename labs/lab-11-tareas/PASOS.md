# Pasos · Lab 11 · Tareas y asincronía
...
```
Lab11Application.java        →  pasos 1 y 3 (las dos anotaciones que lo encienden)
...
**Se escribe:** en `Lab11Application.java`, la anotación que lo enciende:
...
**Se escribe:** en `Lab11Application.java`, la segunda anotación:
...
- Y si la tarea genera folios, se generan dos series — que es el problema del Lab 06, otra vez, y
...
problemas que **no se pueden resolver dentro de un proceso**. El candado del Lab 06 funcionaba
