...
class ArquitecturaTest {
    ...
    @Test
    @DisplayName("AU-01 · la web no toca la entidad")
    void au01() {
        ReglasDeLaCasa.AU_01.check(PRODUCCION);
    }

    @Test
    @DisplayName("AU-02 · ninguna @Entity es alcanzable desde un @RestController")
    void au02() {
        ReglasDeLaCasa.AU_02.check(PRODUCCION);
    }
