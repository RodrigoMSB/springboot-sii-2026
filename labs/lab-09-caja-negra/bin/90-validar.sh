#!/usr/bin/env bash
# =============================================================================
#  90-validar.sh — ¿está tu trabajo listo?  (Lab 09)
# -----------------------------------------------------------------------------
...
resumen_final "🏆 LAB 09 APROBADO — Carolina aprueba. Por ahora." \
              "LAB 09 NO APROBADO — vuelve a la guía que menciona cada error"
VEREDICTO=$?
