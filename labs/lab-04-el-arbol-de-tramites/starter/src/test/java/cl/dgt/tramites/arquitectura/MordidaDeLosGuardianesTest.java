...
class MordidaDeLosGuardianesTest {
    ...
    @Test
    @DisplayName("AU-01 muerde a una clase de web que toca la entidad")
    void au01Muerde() {
        debeMorder(ReglasDeLaCasa.AU_01, "web", "AU01_WebQueTocaLaEntidad");
    }

    @Test
    @DisplayName("AU-02 muerde al controlador que filtra la entidad por el genérico")
    void au02Muerde() {
        debeMorder(ReglasDeLaCasa.AU_02, "au02", "AU02_ControladorQueFiltraEntidad");
    }
