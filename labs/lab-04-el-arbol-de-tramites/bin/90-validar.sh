#!/usr/bin/env bash
# =============================================================================
#  90-validar.sh — ¿está tu trabajo listo?  (Lab 04)
# -----------------------------------------------------------------------------
...
resumen_final "🏆 LAB 04 APROBADO — Carolina aprueba. Por ahora." \
              "LAB 04 NO APROBADO — vuelve a la guía que menciona cada error"
VEREDICTO=$?
