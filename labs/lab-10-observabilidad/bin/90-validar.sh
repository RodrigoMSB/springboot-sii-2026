#!/usr/bin/env bash
# =============================================================================
#  90-validar.sh — ¿está tu trabajo listo?  (Lab 10)
# -----------------------------------------------------------------------------
...
resumen_final "🏆 LAB 10 APROBADO — el tablero dice la verdad. Carolina puede dormir." \
              "LAB 10 NO APROBADO — vuelve a la guía que menciona cada error"
VEREDICTO=$?
