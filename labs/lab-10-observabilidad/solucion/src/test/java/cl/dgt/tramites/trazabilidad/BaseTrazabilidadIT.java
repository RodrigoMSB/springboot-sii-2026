...
/**
 * Base de los tests de TRAZABILIDAD (el enunciado del Lab 09, «Caja negra»): PostgreSQL real
 * (contenedor singleton, ver Lab 08) + login, y un helper para CAPTURAR los logs con un appender en
 * memoria —no se lee un archivo—. Así el test inspecciona el evento de log (su MDC, su mensaje)
 * directamente.
 *
 * <p>Estos tests dejaron de ser el enunciado y pasaron a ser REGRESIÓN: cuando el Lab 10 instrumenta
 * la aplicación con métricas y caché, estas pruebas son las que avisan si de paso rompió el hilo de
 * la traza o el aspecto de auditoría. El enunciado de cada lab vive en {@code enunciado/}; lo que
