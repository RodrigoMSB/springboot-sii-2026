...
descomentan su llamada en `Lab03bApplication`. Los pasos 4 y 8 llevan dos demos cada uno porque
...
2. En `Lab03bApplication`, comentar todas las llamadas **menos** `demos.listarTodas();`.
3. Volver a arrancar.
