...
| | |
|---|---|
| **`practica/`** | Donde trabajas. `Contribuyente` viene dado (es repaso del 3.5); a `Tramite` le falta la relación, y las seis demos llegan vacías. |
...
En `practica/` las seis demos están **comentadas** en `Lab04Application`. Cada paso descomenta la
suya.
...
Tres SELECT de más por no pedirle nada a nadie. Con 6 trámites da igual; el Lab 05 lo hace con
mil.
