...
public class TablaDeRutas {
    ...
    public TablaDeRutas(@Value("${lab14.contribuyentes.url}") String contribuyentes,
                        @Value("${lab14.tramites.url}") String tramites,
                        @Value("${lab14.auditoria.url}") String auditoria) {
