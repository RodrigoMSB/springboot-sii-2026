...
public final class ReglasDeLaCasa {
    ...
    /** AU-07 · La infraestructura no conoce NUESTRA web (sus DTO, sus controladores).
     *
     *  Ojo con el patrón: es `cl.dgt.tramites.web..`, NO `..web..`. El comodín ancho también
     *  matchea `org.springframework.web..`, y la infraestructura SÍ usa el web de Spring —el
     *  cliente declarativo de TESO (`@HttpExchange`, `@GetExchange`) vive de esas anotaciones—.
     *  Lo que la regla prohíbe es depender de la capa web del PROYECTO, no del framework. (Lo
     *  destapó el primer cliente HTTP en infraestructura, Lab 08: el `..web..` era demasiado ancho.) */
    public static final ArchRule AU_07 = noClasses()
            .that().resideInAPackage("..infrastructure..")
            .should().dependOnClassesThat().resideInAPackage("cl.dgt.tramites.web..")
