#!/usr/bin/env bash
# =============================================================================
#  90-validar.sh — ¿está tu trabajo listo?  (Lab 08)
# -----------------------------------------------------------------------------
...
resumen_final "🏆 LAB 08 APROBADO — Carolina aprueba. Por ahora." \
              "LAB 08 NO APROBADO — vuelve a la guía que menciona cada error"
VEREDICTO=$?
