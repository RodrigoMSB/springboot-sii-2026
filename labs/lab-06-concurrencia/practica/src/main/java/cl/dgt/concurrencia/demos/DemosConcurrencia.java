...
/**
 * Las tres demos del laboratorio, declaradas y vacías.
 *
 * <p>Todo el andamiaje —lanzar los hilos, contar repetidos, imprimir el informe— <strong>viene
 * dado</strong> al final de la clase: {@code prepararElAnio()}, {@code enParalelo(...)} e
 * {@code informe()}. Hoy no se aprende a lanzar hilos, se aprende qué pasa cuando compiten.
 *
 * <p>Cada demo es de tres líneas: preparar el año, emitir, informar.
 */
@Component
public class DemosConcurrencia {
    ...
    public void deUnoEnUno() {
        ...
        // escribe aquí
        //
        // prepararElAnio(), un bucle de 10 emisor.emitirIngenuo(ANIO), e informe().
    }
    ...
    public void elCrimen() {
        ...
        // escribe aquí
        //
        // prepararElAnio(), enParalelo(i -> emisor.emitirIngenuo(ANIO)), e informe().
    }
    ...
    public void conCandado() {
        ...
        // escribe aquí
        //
        // lo mismo que la 2, con el emisor que sí pide el candado.
    }
