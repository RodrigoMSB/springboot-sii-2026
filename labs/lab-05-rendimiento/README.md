# Lab 05 · Rendimiento — el N+1

Por qué la pantalla tarda, dicho con un número.

El Lab 04 terminó con una pregunta: si traer un trámite dispara un SELECT extra por su
...
En `practica/` las cinco demos están **comentadas** en `Lab05Application`. Cada paso descomenta la
suya.
...
Leer el SQL fue el Lab 04. **Hoy se cuenta.** Lo que sí está encendido es
