package cl.dgt.auditoria.infra;
...
public final class PuertoLibre {
    ...
    static String mensaje(int puerto) {
        ...
        return """
                ...
                -----------------------------------------------------------------------------
                 Ahi es donde el servicio auditoria levanta su PostgreSQL, asi que no
                 puede arrancar.

                 Lo mas probable: quedo un PostgreSQL vivo de una corrida anterior de ESTE
                 mismo servicio. Al cerrar con Ctrl+C, o al cerrar la terminal de golpe, el
                 motor a veces sobrevive al programa que lo levanto.

                 OJO, que en este lab hay CUATRO terminales: comprueba tambien que no tengas
                 este mismo servicio arrancado en otra de ellas.
                ...
                %s
                 ...
                 Si sigue igual, es que ese mismo servicio TODAVIA corre en otra terminal:
