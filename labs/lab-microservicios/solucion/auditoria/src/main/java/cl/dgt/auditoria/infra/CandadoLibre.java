...
public final class CandadoLibre {
    ...
    static String mensaje(File candado) {
        ...
        String comando = windows
                ...
                + "     (OJO: eso cierra TODOS los servicios y labs que tengas abiertos)"
                : "     lsof -t " + candado.getPath() + " | xargs kill -9";

        return """
                =============================================================================
                 EL SERVICIO auditoria YA ESTA CORRIENDO
                -----------------------------------------------------------------------------
                 El archivo %s esta tomado por otra aplicacion viva, asi
                 que este arranque no puede usar la base.

                 En este lab se abren CUATRO terminales, una por servicio. Lo mas probable es
                 que hayas arrancado auditoria dos veces, en dos terminales distintas.
