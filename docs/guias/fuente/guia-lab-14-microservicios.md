---
title: "Lab 14 · Cuatro oficinas en vez de una"
...
| Estar en la carpeta del lab | `cd labs/lab-14-microservicios/practica` | El `cd` no da error |
...
`labs/lab-14-microservicios/solucion/`.
...
``` bash
cd labs/lab-14-microservicios/practica/contribuyentes && ./mvnw spring-boot:run
cd labs/lab-14-microservicios/practica/tramites       && ./mvnw spring-boot:run
cd labs/lab-14-microservicios/practica/auditoria      && ./mvnw spring-boot:run
cd labs/lab-14-microservicios/practica/gateway        && ./mvnw spring-boot:run
```
...
{{codigo lab=lab-14-microservicios archivo=tramites/src/main/java/cl/dgt/tramites/clientes/ClienteContribuyentes.java modo=metodo nombre=ficha lenguaje=java}}
...
{{codigo lab=lab-14-microservicios archivo=gateway/src/main/java/cl/dgt/gateway/enrutado/TablaDeRutas.java modo=entero lenguaje=java}}
