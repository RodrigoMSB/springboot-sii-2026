...
subtitle: "El lab de microservicios con Docker · Guía del instructor · Curso de Spring Boot · SII 2026"
date: "15 minutos proyectando · Docker Compose · el mismo sistema del Lab de Microservicios"
abstract-title: "Lo que se demuestra"
abstract: |
  Que el sistema del Lab de Microservicios **no cambia** al meterlo en contenedores —el código es el mismo, byte
...
instalarlo — ése fue el motivo de retirar el Lab de Microservicios antiguo, que sí lo pedía. Aquí se proyecta,
...
{{codigo raiz=demos-instructor/microservicios-docker archivo=compose.yaml modo=entre desde="  tramites:" hasta="    restart: unless-stopped" lenguaje=yaml}}
...
{{codigo lab=lab-microservicios archivo=contribuyentes/src/main/java/cl/dgt/contribuyentes/ContribuyentesApplication.java modo=metodo nombre=main lenguaje=java}}

Y así aquí:

{{codigo raiz=demos-instructor/microservicios-docker/sistema archivo=contribuyentes/src/main/java/cl/dgt/contribuyentes/ContribuyentesApplication.java modo=metodo nombre=main lenguaje=java}}
...
{{codigo raiz=demos-instructor/microservicios-docker archivo=compose.yaml modo=clave clave=networks lenguaje=yaml}}
...
{{codigo raiz=demos-instructor/microservicios-docker/sistema archivo=gateway/src/main/resources/application.yml modo=clave clave=microservicios lenguaje=yaml}}
...
que el Lab de Microservicios antiguo montaba con un Eureka —un servicio más que arrancar, configurar y operar—,
