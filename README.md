...
| [`lab-microservicios`](labs/lab-microservicios/) | Microservicios | Cuatro procesos y tres bases: el JOIN imposible, el fallo en cascada (**500 → 200 degradado**), el gateway, y cuándo **no** partir un sistema |
