    ...
    SecurityFilterChain cadena(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(rutas -> rutas
                        ...
                        // =========================================================================
                        //  HUECO 12 · Quien puede ver las oficinas
                        // -------------------------------------------------------------------------
                        //  Hoy cualquiera con un token entra a todo. Las oficinas son material de
                        //  fiscalizacion: solo el rol FISCALIZADOR puede verlas.
                        //
                        //  Sin token tiene que salir 401; con token y el rol equivocado, 403.
                        //  Los usuarios sembrados son `ana` (FISCALIZADOR) y `luis` (CONTRIBUYENTE).
                        //
                        //  ESTA LISTO CUANDO · pasa el test H-12
                        // =========================================================================
